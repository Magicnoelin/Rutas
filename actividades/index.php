 ...
 * URL canónica: https://rutasrurales.io/actividades/
 */
ini_set('display_errors', 0); error_reporting(E_ERROR | E_PARSE);
$base_domain = 'https://rutasrurales.io';
$canonical   = $base_domain . '/actividades/';
$meta_title  = 'Actividades Turísticas en España | Senderismo, Rutas y Turismo Rural';
$meta_desc   = 'Más de 300 actividades turísticas en España: senderismo, rutas en bici, kayak, birdwatching, ecoturismo y experiencias únicas en entornos rurales.';
$og_image    = $base_domain . '/menu_images/og-default.jpg';

$actividades = [
  'senderismo'     => ['icon'=>'🥾','label'=>'Senderismo','desc'=>'Rutas y caminos por la naturaleza'],
  'rutas-en-bici'  => ['icon'=>'🚴','label'=>'Rutas en bici','desc'=>'BTT y cicloturismo rural'],
  'kayak-canoa'    => ['icon'=>'🛶','label'=>'Kayak y canoa','desc'=>'Deportes de agua dulce'],
  'birdwatching'   => ['icon'=>'🦅','label'=>'Birdwatching','desc'=>'Avistamiento de aves'],
  'ecoturismo'     => ['icon'=>'🌿','label'=>'Ecoturismo','desc'=>'Turismo responsable y sostenible'],
  'escalada'       => ['icon'=>'🧗','label'=>'Escalada','desc'=>'Rocódromos y vías ferrata'],
  'rutas-caballo'  => ['icon'=>'🐴','label'=>'Rutas a caballo','desc'=>'Equiturismo rural'],
  'fotografía'     => ['icon'=>'📷','label'=>'Fotografía naturaleza','desc'=>'Paisajes y fauna silvestre'],
  'astronomia'     => ['icon'=>'🔭','label'=>'Astronomía','desc'=>'Cielos oscuros y stargazing'],
  'micologia'      => ['icon'=>'🍄','label'=>'Micología','desc'=>'Rutas y recogida de setas'],
  'setas-guiada'   => ['icon'=>'🌲','label'=>'Rutas guiadas','desc'=>'Con guía experto local'],
  'nieve-invierno' => ['icon'=>'❄️','label'=>'Nieve e invierno','desc'=>'Raquetas de nieve y esquí nordic'],
];
...
<link rel="alternate" hreflang="es"        href="https://rutasrurales.io/actividades/">
<link rel="alternate" hreflang="x-default" href="https://rutasrurales.io/actividades/">
...
<section class="act-hero" id="inicio" aria-labelledby="act-h1">
  ...
  <div class="act-hero__inner">
    <nav class="act-bc" aria-label="Ruta de navegación">
      <ol>
        <li><a href="https://rutasrurales.io/">Inicio</a></li>
        <li aria-hidden="true" style="padding:0 4px">›</li>
        <li><span aria-current="page" style="color:#fff">Actividades turísticas</span></li>
      </ol>
    </nav>
    <h1 id="act-h1">Actividades Turísticas en España</h1>
    <p class="act-hero__sub">Senderismo, rutas en bici, kayak, birdwatching, astronomía y decenas de experiencias únicas en entornos rurales de toda España.</p>
...
<section class="act-section act-section--alt" aria-labelledby="tipos-h2">
  <div class="act-wrap">
    <h2 class="act-h2" id="tipos-h2">🏃 Explorar por tipo de actividad</h2>
    <p class="act-intro">Elige la actividad que más se adapte a tu nivel y preferencias. Todas en entornos naturales de España.</p>
    <ul class="act-grid" role="list" aria-label="Tipos de actividades turísticas">
...
<section class="act-section" aria-labelledby="prov-h2">
  <div class="act-wrap">
    <h2 class="act-h2" id="prov-h2">📍 Actividades por provincia</h2>
    <p class="act-intro">Descubre qué hacer en cada provincia: rutas, deportes de aventura y experiencias con la naturaleza.</p>
    <ul class="act-provs" role="list" aria-label="Provincias con actividades turísticas">
...
<!-- CTA -->
<section class="act-cta" aria-label="Añadir una actividad">
  <h2>¿Ofreces actividades al aire libre?</h2>
  <p>Publica tus rutas, talleres o experiencias de naturaleza y conecta con turistas que buscan aventura rural.</p>
  <a href="/agregar-actividad.html" class="act-btn act-btn--w">Añadir mi actividad</a>
  <a href="/rutas.php?alojamientos=0&lugares=0&actividades=1&eventos=0" class="act-btn act-btn--o">🗺️ Ver en el mapa</a>
</section>
