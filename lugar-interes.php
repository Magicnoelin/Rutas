...
try {
    ...
    // Recopilar fotos - primero fotos legacy (photo1-4)
    $fotos = [];
    $fotoCreditos = [];
    
    // Primero añadir fotos legacy (photo1-4)
    ...
    // Ahora intentar obtener los créditos de las fotos desde entity_photos
    try {
        // Obtener fotos con créditos
        ...
        if (!empty($fotosEntity)) {
            // Limpiar fotos y usar las de entity_photos
            $fotos = [];
        ...
        // Si falla la consulta de entity_photos, mantener fotos legacy
    }
