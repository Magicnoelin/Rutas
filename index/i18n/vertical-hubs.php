...
const VH_I18N = [
    'es' => [
        ...
        'lug_in_spain' => 'en España',
        'lug_landing_back' => '← Volver a Lugares de interés',
        'lug_landing_by_province' => '📍 Lugares de interés en',
        'lug_landing_cat_in_spain' => 'en España',
        'lug_landing_results' => 'resultado',
        'lug_landing_results_pl' => 'resultados',
        'lug_landing_found' => 'lugar encontrado',
        'lug_landing_found_pl' => 'lugares encontrados',
        'lug_landing_free_entry' => 'Entrada libre',
        'lug_landing_free' => '✓ Gratis',
        'lug_landing_see_more' => 'Ver más',
        'lug_landing_no_results_h3' => 'Aún no hay lugares publicados aquí',
        'lug_landing_no_results_p' => '¡Sé el primero en añadir un lugar en esta sección!',
        'lug_landing_add' => 'Añadir un lugar',
        'lug_landing_map_all' => '🗺️ Ver todos en el mapa interactivo',
        'lug_landing_map_prov' => '🗺️ Ver en el mapa',
        'lug_landing_cta_h2' => '¿Conoces un lugar con encanto?',
        'lug_landing_cta_p' => 'Comparte tu restaurante, bodega, monumento o espacio natural con viajeros de toda España.',
        'lug_landing_back_all' => '← Ver todos los tipos',
        'lug_landing_breadcrumb_places' => 'Lugares de interés',
        'lug_landing_nav_aria' => 'Menú principal',
    ...
    'en' => [
        ...
        'lug_in_spain' => 'in Spain',
        'lug_landing_back' => '← Back to Places of Interest',
        'lug_landing_by_province' => '📍 Places of Interest in',
        'lug_landing_cat_in_spain' => 'in Spain',
        'lug_landing_results' => 'result',
        'lug_landing_results_pl' => 'results',
        'lug_landing_found' => 'place found',
        'lug_landing_found_pl' => 'places found',
        'lug_landing_free_entry' => 'Free entry',
        'lug_landing_free' => '✓ Free',
        'lug_landing_see_more' => 'See more',
        'lug_landing_no_results_h3' => 'No places published here yet',
        'lug_landing_no_results_p' => 'Be the first to add a place in this section!',
        'lug_landing_add' => 'Add a place',
        'lug_landing_map_all' => '🗺️ View all on interactive map',
        'lug_landing_map_prov' => '🗺️ View on map',
        'lug_landing_cta_h2' => 'Know a charming place?',
        'lug_landing_cta_p' => 'Share your restaurant, winery, monument or natural space with travellers across Spain.',
        'lug_landing_back_all' => '← View all types',
        'lug_landing_breadcrumb_places' => 'Places of Interest',
        'lug_landing_nav_aria' => 'Main menu',
    ...
    'fr' => [
        ...
        'lug_in_spain' => 'en Espagne',
        'lug_landing_back' => '← Retour aux Lieux d\'intérêt',
        'lug_landing_by_province' => '📍 Lieux d\'intérêt en',
        'lug_landing_cat_in_spain' => 'en Espagne',
        'lug_landing_results' => 'résultat',
        'lug_landing_results_pl' => 'résultats',
        'lug_landing_found' => 'lieu trouvé',
        'lug_landing_found_pl' => 'lieux trouvés',
        'lug_landing_free_entry' => 'Entrée libre',
        'lug_landing_free' => '✓ Gratuit',
        'lug_landing_see_more' => 'Voir plus',
        'lug_landing_no_results_h3' => 'Aucun lieu publié ici pour le moment',
        'lug_landing_no_results_p' => 'Soyez le premier à ajouter un lieu dans cette section !',
        'lug_landing_add' => 'Ajouter un lieu',
        'lug_landing_map_all' => '🗺️ Voir tous sur la carte interactive',
        'lug_landing_map_prov' => '🗺️ Voir sur la carte',
        'lug_landing_cta_h2' => 'Vous connaissez un lieu de charme ?',
        'lug_landing_cta_p' => 'Partagez votre restaurant, cave, monument ou espace naturel avec des voyageurs de toute l\'Espagne.',
        'lug_landing_back_all' => '← Voir tous les types',
        'lug_landing_breadcrumb_places' => 'Lieux d\'intérêt',
        'lug_landing_nav_aria' => 'Menu principal',
    ...
    'de' => [
        ...
        'lug_in_spain' => 'in Spanien',
        'lug_landing_back' => '← Zurück zu Sehenswürdigkeiten',
        'lug_landing_by_province' => '📍 Sehenswürdigkeiten in',
        'lug_landing_cat_in_spain' => 'in Spanien',
        'lug_landing_results' => 'Ergebnis',
        'lug_landing_results_pl' => 'Ergebnisse',
        'lug_landing_found' => 'Ort gefunden',
        'lug_landing_found_pl' => 'Orte gefunden',
        'lug_landing_free_entry' => 'Freier Eintritt',
        'lug_landing_free' => '✓ Kostenlos',
        'lug_landing_see_more' => 'Mehr sehen',
        'lug_landing_no_results_h3' => 'Noch keine Orte hier veröffentlicht',
        'lug_landing_no_results_p' => 'Seien Sie der Erste, der einen Ort in diesem Bereich hinzufügt!',
        'lug_landing_add' => 'Ort hinzufügen',
        'lug_landing_map_all' => '🗺️ Alle auf der interaktiven Karte anzeigen',
        'lug_landing_map_prov' => '🗺️ Auf der Karte anzeigen',
        'lug_landing_cta_h2' => 'Kennen Sie einen charmanten Ort?',
        'lug_landing_cta_p' => 'Teilen Sie Ihr Restaurant, Weingut, Denkmal oder Naturgebiet mit Reisenden aus ganz Spanien.',
        'lug_landing_back_all' => '← Alle Typen anzeigen',
        'lug_landing_breadcrumb_places' => 'Sehenswürdigkeiten',
        'lug_landing_nav_aria' => 'Hauptmenü',
    ...
    'zh' => [
        ...
        'lug_in_spain' => '在西班牙',
        'lug_landing_back' => '← 返回景点列表',
        'lug_landing_by_province' => '📍 景点 —',
        'lug_landing_cat_in_spain' => '在西班牙',
        'lug_landing_results' => '个结果',
        'lug_landing_results_pl' => '个结果',
        'lug_landing_found' => '个景点',
        'lug_landing_found_pl' => '个景点',
        'lug_landing_free_entry' => '免费入场',
        'lug_landing_free' => '✓ 免费',
        'lug_landing_see_more' => '查看更多',
        'lug_landing_no_results_h3' => '此处暂无已发布的景点',
        'lug_landing_no_results_p' => '成为第一个在此添加景点的人！',
        'lug_landing_add' => '添加景点',
        'lug_landing_map_all' => '🗺️ 在互动地图上查看全部',
        'lug_landing_map_prov' => '🗺️ 在地图上查看',
        'lug_landing_cta_h2' => '您知道有魅力的地方吗？',
        'lug_landing_cta_p' => '与全西班牙的旅行者分享您的餐厅、酒庄、古迹或自然空间。',
        'lug_landing_back_all' => '← 查看所有类型',
        'lug_landing_breadcrumb_places' => '景点',
        'lug_landing_nav_aria' => '主菜单',
