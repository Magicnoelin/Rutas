    ...
    container.innerHTML = shown.map(l => `
        <a href="${l.url}" class="nearby-card" style="text-decoration:none;color:inherit;">
            ...
            <div class="nearby-card-body">
                ...
                ${l.short_description ? `<div class="nearby-card-desc" style="font-size:0.75rem;color:#666;margin:4px 0;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;">${l.short_description}</div>` : ''}
