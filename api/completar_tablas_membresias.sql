...
-- 8. CREAR O REEMPLAZAR PROCEDIMIENTO PARA ACTUALIZAR ESTADOS DE SUSCRIPCIÓN
DROP PROCEDURE IF EXISTS update_subscription_statuses;
DELIMITER //
...
-- 9. CREAR O REEMPLAZAR EVENTO PARA EJECUTAR PROCEDIMIENTO DIARIAMENTE
DROP EVENT IF EXISTS daily_subscription_maintenance;
CREATE EVENT daily_subscription_maintenance
...
-- 12. CREAR O REEMPLAZAR FUNCIÓN PARA OBTENER CONFIGURACIÓN
