...
$ui = [
    'es' => [
        ...
        'estrellas_calidad'    => 'estrellas de calidad',
        'sin_aloj_cercanos'    => 'No se encontraron alojamientos cercanos.',
        'sin_activ_cercanas'   => 'No se encontraron actividades cercanas.',
        'sin_eventos_cercanos' => 'No se encontraron eventos cercanos.',
        'sin_lugares_cercanos' => 'No se encontraron lugares de interés cercanos.',
        'precio_noche'         => '€/noche',
        'precio_persona'       => '€/persona',
    ],
    'en' => [
        ...
        'estrellas_calidad'    => 'quality stars',
        'sin_aloj_cercanos'    => 'No nearby accommodation found.',
        'sin_activ_cercanas'   => 'No nearby activities found.',
        'sin_eventos_cercanos' => 'No nearby events found.',
        'sin_lugares_cercanos' => 'No nearby places of interest found.',
        'precio_noche'         => '€/night',
        'precio_persona'       => '€/person',
    ],
    'fr' => [
        ...
        'estrellas_calidad'    => 'étoiles de qualité',
        'sin_aloj_cercanos'    => 'Aucun hébergement à proximité trouvé.',
        'sin_activ_cercanas'   => 'Aucune activité à proximité trouvée.',
        'sin_eventos_cercanos' => 'Aucun événement à proximité trouvé.',
        'sin_lugares_cercanos' => 'Aucun lieu d\'intérêt à proximité trouvé.',
        'precio_noche'         => '€/nuit',
        'precio_persona'       => '€/personne',
    ],
    'de' => [
        ...
        'estrellas_calidad'    => 'Qualitätssterne',
        'sin_aloj_cercanos'    => 'Keine nahegelegenen Unterkünfte gefunden.',
        'sin_activ_cercanas'   => 'Keine nahegelegenen Aktivitäten gefunden.',
        'sin_eventos_cercanos' => 'Keine nahegelegenen Veranstaltungen gefunden.',
        'sin_lugares_cercanos' => 'Keine nahegelegenen Sehenswürdigkeiten gefunden.',
        'precio_noche'         => '€/Nacht',
        'precio_persona'       => '€/Person',
    ],
    'zh' => [
        ...
        'cookies'              => 'Cookies',
        'agradecimientos'      => '致谢',
        'estrellas_calidad'    => '质量星级',
        'sin_aloj_cercanos'    => '未找到附近住宿。',
        'sin_activ_cercanas'   => '未找到附近活动。',
        'sin_eventos_cercanos' => '未找到附近活动。',
        'sin_lugares_cercanos' => '未找到附近景点。',
        'precio_noche'         => '€/晚',
        'precio_persona'       => '€/人',
    ],
];
