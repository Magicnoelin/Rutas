<?php
/**
 * GENERAR TRADUCCIONES DE EVENTOS CULTURALES
 * Ejecuta el script SQL para completar traducciones faltantes
 * Llamado desde eventos_index.php
 */
...
-- 5. ACTUALIZAR TRADUCCIONES EXISTENTES INCOMPLETAS
-- 5.1 INGLÉS (en)
...
// 3. EJECUTAR CADA SENTENCIA POR SEPARADO
$queries = explode('-- ' . PHP_EOL, $sql_script);
$resultados = [];
$errores = [];
$total_afectadas = 0;
        ...
        <div class="container py-5">
            <div class="card shadow border-0">
                <div class="card-header bg-success text-white">
                    <h4 class="mb-0"><i class="bi bi-check-circle-fill"></i> Traducciones generadas correctamente</h4>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr><td>Total eventos activos</td><td><strong><?= $resumen['total_eventos'] ?></strong></td></tr>
                            <tr><td>Eventos con inglés (en)</td><td><strong><?= $resumen['eventos_con_en'] ?></strong></td></tr>
                            <tr><td>Eventos con francés (fr)</td><td><strong><?= $resumen['eventos_con_fr'] ?></strong></td></tr>
                            <tr><td>Eventos con alemán (de)</td><td><strong><?= $resumen['eventos_con_de'] ?></strong></td></tr>
                            <tr><td>Eventos con chino (zh)</td><td><strong><?= $resumen['eventos_con_zh'] ?></strong></td></tr>
                            <tr class="table-success">
                                <td><strong>Eventos COMPLETOS (4 idiomas)</strong></td>
                                <td><strong><?= $resumen['eventos_completos'] ?> / <?= $resumen['total_eventos'] ?></strong></td>
                            </tr>
                        </tbody>
                    </table>
                    <a href="eventos_index.php" class="btn btn-primary">
