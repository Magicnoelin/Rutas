...
if (!isset($_GET['id']) || empty($_GET['id'])) { 
    ...
    try {
        ...
        $muni = isset($_GET['municipality']) ? $_GET['municipality'] : '';
        $prov = isset($_GET['province']) ? $_GET['province'] : 'Soria';
        ...
        header("Location: lugares_editar.php?id=" . $id . "&from_suggested=" . $fromSuggested);
        exit;
    } catch (Exception $e) {
        die("Error al crear lugar: " . $e->getMessage());
    }
}
...
<div class="container mt-3 pb-5">
    <form action="guardar_lugar.php" method="POST">
        ...
        <!-- Campo oculto para transferir fotos de sugerencia -->
        <input type="hidden" name="from_suggested_id" value="<?= isset($_GET['from_suggested']) ? (int)$_GET['from_suggested'] : '' ?>">
