...
<div class="container pb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="seo-preview shadow-sm mt-3">
                                ...
                                <div class="seo-url">rutasrurales.io › <?= $item['slug'] ?></div>
    ...
    <input type="text" name="name" class="form-control form-control-lg" value="<?= htmlspecialchars($item['name']) ?>" required>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="is_active" class="form-select">
                            <option value="1" <?= $item['is_active'] ? 'selected' : '' ?>>Publicado</option>
                            <option value="0" <?= !$item['is_active'] ? 'selected' : '' ?>>Borrador</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold small text-primary">Slug (URL)</label>
                        <input type="text" name="slug" class="form-control bg-light" value="<?= htmlspecialchars($item['slug']) ?>">
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-bold small text-danger"><i class="bi bi-instagram_url"></i> instagram_url (URL Perfil)</label>
                        <input type="text" name="instagram" class="form-control" value="<?= htmlspecialchars($item['instagram_url'] ?? '') ?>" placeholder="https://instagram.com/nombre...">
                    </div>
                </div>
