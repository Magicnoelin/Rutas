 ...
 * Esta página NO requiere contraseña de admin, solo verificación de sesión de usuario
 */
// Iniciar sesión y verificar que el usuario está logueado
session_start();
...
if (!isset($_SESSION['user_id'])) {
    header("Location: login.html?redirect=editar-alojamiento.php?id=" . $id);
    exit;
}
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 border rounded bg-light">
                                ...
                                <input type="text" name="<?= $f ?>" class="form-control mb-2" value="<?= htmlspecialchars($item[$f] ?? '') ?>" placeholder="URL de la foto">
                                <?php if(!empty($item[$f])): ?>
